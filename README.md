...
# [Built Portfolio With GitHub ](https://github.com/anujchauhann09/personal-portfolio)

---

# Personal Portfolio

#### Are you struggling to create a professional portfolio website? Look no further! You can use the Personal Portfolio template and create your very own personalized portfolio today! My website is designed to be user-friendly and easily customizable, making it perfect for both personal and freelancers.
...
### Then, Customize data in the `utils/data` [folder](https://github.com/anujchauhann09/personal-portfolio/tree/main/utils/data).
...
export const personalData = {
  ...
  resume: 'https://drive.google.com/file/d/1rnGPCilwmEk4PSD4qkcQaFCLYZ9ceatz/view?usp=sharing'
}
```
